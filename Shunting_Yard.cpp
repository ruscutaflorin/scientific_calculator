...
//}
//
//Shunting_Yard::Shunting_Yard(string expresie) : Shunting_Yard() {
//    if (expresie.length() > 0) {
//        this->expresie = expresie;
//    }
//}
...
//        } else if (validareTip(this->expresie[0]) == 1) {
//            rezultat += " ";
//            while (!operatorStack.isEmpty() && validareTip(operatorStack.getLastElement()) != 2 &&
//                   prioritate(this->expresie[0]) <= prioritate(operatorStack.getLastElement())) {
//                rezultat += operatorStack.getLastElement();
//                rezultat += " ";
//                operatorStack.pop();
//            }
